...
func Init() {
	...
	message.SetString(en, "command.churches_count", command.EnCommandChurchesCount())
	...
	message.SetString(uk, "command.churches_count", command.UkCommandChurchesCount())
	...
	message.SetString(ru, "command.churches_count", command.RuCommandChurchesCount())
